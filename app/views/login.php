...
<div class="login-page">
  ...
  <!-- ── PAINEL ESQUERDO — Branding (layout customizado, sem equivalente Bootstrap) ── -->
  ...
  <div class="login-form-panel">
    <div class="login-box">
      ...
      <!-- Toggle tipo de acesso (sem equivalente direto no Bootstrap) -->
      ...
      <form method="POST" action="../public/?page=auth">
        ...
        <!-- Botão: Bootstrap btn-success com override de marca via safrawise.css -->
